    ...
    public class Config : IConfig
    {
        ...
        public string Language
        {
            ...
            private set
            {
                ...
                if (string.IsNullOrEmpty(ChatMutedBroadcast?.Content))
                    ChatMutedBroadcast.Content = Localizations.Language.PlayerHasBeenChatMuted;

                if (string.IsNullOrEmpty(PrivateMessageNotificationBroadcast?.Content))
                    PrivateMessageNotificationBroadcast.Content = Localizations.Language.PlayerReceivedPrivateMessage;
